...
import { CustomCheckoutFieldsSchema, type CustomCheckoutFields } from "@/lib/commerce-custom-checkout-fields";
export {
  CustomCheckoutFieldSchema,
  CustomCheckoutFieldsSchema,
  type CustomCheckoutField,
  type CustomCheckoutFields,
} from "@/lib/commerce-custom-checkout-fields";
