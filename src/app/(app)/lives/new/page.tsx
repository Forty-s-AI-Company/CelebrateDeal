...
export default async function NewLivePage() {
  ...
  const [videos, products, forms, templates, scripts, affiliates] = await Promise.all([
  ...
  return (
    <>
      ...
      <LiveStepperForm videos={videos} products={products} forms={forms} templates={templates} scripts={scripts} affiliates={affiliates} />
    </>
  );
}
