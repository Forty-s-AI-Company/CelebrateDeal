        ...
        <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            {live.isEvergreen && live.evergreenPreviewEnabled && live.video?.videoUrl ? (
              ...
              <div className="rounded-lg bg-slate-100 bg-cover bg-center" style={{ aspectRatio: liveOrientation(live.presenterLayout) === "portrait" ? "9 / 16" : "16 / 9", backgroundImage: live.heroImageUrl ? `url(${live.heroImageUrl})` : undefined }} />
            )}
