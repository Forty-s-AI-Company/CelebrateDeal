...
export default async function NewInteractionRolePage({
  ...
  return (
    <>
      <PageHeader
        title="互動角色"
        description="選擇頭像、輸入暱稱與角色類型，即可建立可重複使用的官方互動角色。"
        action={
          <form action={importSystemRolesAction}>
            ...
            <FormSubmitButton
              ...
              className="h-10 rounded-md border border-blue-200 bg-blue-50 px-4 text-sm font-semibold text-blue-700 shadow-sm hover:bg-blue-100"
            >
              匯入 10 個官方角色
            </FormSubmitButton>
          </form>
