...
/**
 * Reconciles or verifies the deployment-owned WP4 Sandbox fixed SaaS subscription refund.
...
export async function POST(request: Request) {
  ...
  try {
    const result = await reconcileWp4PayUniSandboxSubscriptionRefund(getDb(), expectedSha);
