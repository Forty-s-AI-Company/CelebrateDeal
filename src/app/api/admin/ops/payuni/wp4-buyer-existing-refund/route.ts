...
import { continueWp4BuyerRefund } from "@/lib/wp4-payuni-buyer-continuation";
...
export async function POST(request: Request) {
  ...
  try { return NextResponse.json(await continueWp4BuyerRefund(getDb()), { status: 200, headers: { "Cache-Control": "no-store" } }); } catch { return unavailable(503); }
}
