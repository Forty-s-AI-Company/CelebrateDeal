  ...
  it("shows filters and makes missing, zero-denominator, and delayed data explicit", () => {
    const html = renderToStaticMarkup(<TeamPerformanceDashboard
      ...
      report={{
        ...
        rows: [
          { pageId: "page-1", pageSlug: "b-page", templateId: "template-1", templateName: "夏季模板", templateVersion: 2, partnerMembershipId: "member-b", partnerName: "B 夥伴", views: null, clicks: 0, submissions: 0, viewToClickRate: null, viewToSubmissionRate: null, analyticsState: "missing" },
          { pageId: "page-2", pageSlug: "zero-page", templateId: "template-1", templateName: "夏季模板", templateVersion: 1, partnerMembershipId: "member-b", partnerName: "B 夥伴", views: 0, clicks: 0, submissions: 0, viewToClickRate: null, viewToSubmissionRate: null, analyticsState: "available" },
        ],
      }}
    />);
  ...
  it("renders observed counts and rates without replacing them with estimates", () => {
    const html = renderToStaticMarkup(<TeamPerformanceDashboard
      ...
      report={{
        ...
        templates: [], partners: [],
        rows: [{ pageId: "page-1", pageSlug: "mine", templateId: "template-1", templateName: "夏季模板", templateVersion: 2, partnerMembershipId: "member-b", partnerName: "B 夥伴", views: 20, clicks: 4, submissions: 2, viewToClickRate: 20, viewToSubmissionRate: 10, analyticsState: "available" }],
      }}
    />);
