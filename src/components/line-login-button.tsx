  ...
  return (
    <div>
      <button
        ...
        className="inline-flex min-h-11 items-center justify-center rounded-md bg-[#06C755] px-4 text-sm font-bold text-slate-950 hover:bg-[#05b64d] disabled:opacity-60"
      >
  ...
  return (
    <div className="mt-6 border-t border-slate-200 pt-5">
      ...
      <button
        ...
        className="mt-3 inline-flex min-h-11 w-full items-center justify-center rounded-md bg-[#06C755] px-4 font-bold text-slate-950 hover:bg-[#05b64d] disabled:opacity-60"
      >
