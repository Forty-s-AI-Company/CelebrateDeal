...
export function FunnelStepPagesEditor({ state, disabled = false, onChange, onStepMutation }: { state: FunnelStepPages; disabled?: boolean; onChange: (state: FunnelStepPages) => void; onStepMutation?: (state: FunnelStepPages, mutation: FunnelStepPersistenceMutation) => void }) {
