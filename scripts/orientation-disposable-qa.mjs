...
const evidencePath = path.join(root, "docs/live-feature-handoffs/orientation-db-evidence.json");
...
try {
  ...
  fs.writeFileSync(path.join(root, "docs/live-feature-handoffs/orientation-db-evidence.json"), JSON.stringify(receipt, null, 2));
}
