...
const receiptPath = path.join(workspaceRoot, ".ai-team", "reports", "g7-24-checkout-recovery-controlled-build-20260809.json");

const startedAt = new Date().toISOString();
const result = await runControlledProductionBuild({ sourceRoot: workspaceRoot });
const receipt = {
  schemaVersion: "celebratedeal-g7-checkout-recovery-controlled-build/v1",
  workPackage: "G7-24",
