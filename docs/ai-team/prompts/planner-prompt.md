...
先讀取：AGENTS.md、docs/ai-team/workflow-policy.md、docs/ai-team/handoff-schema.md、docs/launch/next-work-packages.md、.ai-team/state/goal-state.json，以及本次所需 evidence 與 Git 狀態。
