...
> 歷史工作包索引（2026-07）。本檔的固定 30–90 分鐘、逐包停止與舊模型建議只記錄當時做法，不再約束現在的 Goal。現行工作、授權及驗收請見 [CURRENT.md](CURRENT.md) 與 [Goal Plan](goal-plan-20260924.md)。以下舊驗收紀錄保持原貌。

以下工作包與時程是建立當時的歷史紀錄；目前可在同一 Goal 內連續完成多個工作包。
