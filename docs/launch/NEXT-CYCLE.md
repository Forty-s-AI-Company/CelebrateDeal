...
2. **Dashboard 與 R2 最終來源重驗**：前一來源的 [瀏覽器 run 36264888394](https://github.com/Forty-s-AI-Company/CelebrateDeal/actions/runs/36264888394) 與 [R2 run 36265531030](https://github.com/Forty-s-AI-Company/CelebrateDeal/actions/runs/36265531030) PASS；每次固定站來源更新後，需核對 immutable host／alias 並重驗 desktop/mobile 導頁、關鍵資源與合成圖片預簽、PUT、公開讀取。舊來源曾有偶發腳本失敗與 Dashboard 逾時，單次 PASS 不能證明永不再發生。
