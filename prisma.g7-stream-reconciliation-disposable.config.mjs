...
if (parsed.protocol !== "postgresql:" || parsed.hostname !== "127.0.0.1") {
  throw new Error("[g7_stream_reconciliation_db] only loopback PostgreSQL is allowed");
}
if (!/^g7_12_[a-f0-9]{16}$/u.test(schema) || parsed.searchParams.get("schema") !== schema) {
